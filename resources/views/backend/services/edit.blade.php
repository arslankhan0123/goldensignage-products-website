                    ...
                    <form
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="mb-2" id="currentImage">
                                <img src="{{asset($service->image)}}" alt="{{$service->name}}" style="max-width: 200px; height: auto; border-radius: 8px; border: 1px solid #e0e0e0;">
                            </div>
                            @endif
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="long_description" id="long_description" style="display: none;">{{old('long_description', $service->long_description)}}</textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="{{route('services.index')}}" class="btn btn-secondary ms-2">
                                Cancel
                            </a>
                        </div>
                    </form>
...
<script>
    (function() {
        ...
        function initQuill() {
            ...
            // Set initial content
            @if(old('long_description', $service->long_description))
                const oldContent = {!! json_encode(old('long_description', $service->long_description)) !!};
    ...
    document.getElementById('category_id')?.addEventListener('change', function() {
        ...
        const currentProductId = {{$service->id}};
        const currentParentId = {{$service->parent_id ?? 'null'}};
