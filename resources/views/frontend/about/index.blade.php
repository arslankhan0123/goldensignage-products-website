...
@section('title', 'About Golden Signage UAE')
@section('description', 'Learn about Golden Signage, a UAE provider of professional custom signage, branding, printing and display solutions.')
@section('meta')
@endsection
