            ...
            <div class="col-lg-6 col-md-12">
                <div class="products-details-desc">
                    ...
                    <div class="products-add-to-cart align-items-center">
                        ...
                        <a type="submit" href="{{route ('frontend.contact')}}" class="default-btn"><span>Contact Us for Add to Cart</span></a>
                ...
                <div class="single-products-card">
                    <div class="products-image">
                        ...
                        <div class="add-to-cart-btn">
                            <a href="{{ route('frontend.contact') }}" class="default-btn">Contact Us for Add to Cart</a>
                        </div>
                    </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="overview-card">
                    <h3>Email Us</h3>
                    <span>
                        <a href="/cdn-cgi/l/email-protection#107879737f6a7550777d71797c3e737f7d"><span class="__cf_email__" data-cfemail="6f07060c00150a2f08020e0603410c0002">[email&#160;protected]</span></a>
                    </span>
