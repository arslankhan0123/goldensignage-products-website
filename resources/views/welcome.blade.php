        ...
        <div class="signage-grid">
            ...
            <div class="signage-large">
                ...
                <div class="overlay">
                    ...
                    <a href="{{ route('frontend.our-products', ['category' => 10]) }}" class="explore-btn">Discover
                        →</a>
                </div>
            </div>
            ...
            <div class="signage-right">
                ...
                <div class="signage-card">
                    <img src="{{ asset('/signages.png') }}" alt="Signages">
                ...
                <div class="signage-card">
                    <img src="{{ asset('/name-plate.png') }}" alt="Name Plates">
                    <div class="card-overlay">
                        <h3>Name Plates</h3>
                        <span>
...
<section class="trusted-section">
    <div class="container">
        <div class="section-title text-center" style="margin: 0 auto 45px; text-align: center;">
            <h2 style="color:black">Businesses that Trust Golden Signage</h2>
        </div>
        ...
        <div class="owl-carousel trusted-carousel">
            ...
            <div class="logo-item">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/500px-Google_%22G%22_logo.svg.png"
                    alt="Google" style="height: 80px; width: auto; margin: 0 auto;">
            </div>
            ...
            <div class="logo-item">
                <img src="	https://signset.com.pk/wp-content/uploads/2021/06/SIGNSET-Pvt-Ltd-Logo.png" alt="Amazon"
                    style="height: 80px; width: auto; margin: 0 auto;">
            </div>
            ...
            <div class="logo-item">
                <img src="https://masssign.pk/wp-content/uploads/2022/11/Mass-Sign-Logo.jpg" alt="Coca-Cola"
                    style="height: 80px; width: auto; margin: 0 auto;">
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="testimonials-slides owl-carousel owl-theme">
            ...
            <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="50">
                <p>The entire experience was smooth and well-organized. The team maintained clear communication and
                    delivered results that truly reflected professionalism and quality.</p>
            ...
            <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="80">
                <p>We were impressed by the attention to detail and the structured approach. Everything was handled
                    efficiently, making the collaboration stress-free.</p>
                <div class="info-item-box">
            ...
            <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="60">
                <p>The professionalism shown throughout the process was outstanding. Timelines were respected, and the
                    final outcome met our expectations perfectly.</p>
                <div class="info-item-box">
            ...
            <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="70">
                <p>A reliable and dedicated team that understands requirements clearly. The entire workflow felt
                    organized and highly professional.</p>
                <div class="info-item-box">
            ...
            <div class="single-testimonials-card" data-aos="fade-up" data-aos-delay="90">
                <p>Everything was handled with care and precision. The communication was clear, and the results
                    reflected a strong commitment to quality.</p>
                <div class="info-item-box">
            ...
            <div class="single-testimonials-card" data-aos="fade-up">
                <p>The team delivered exactly what was promised. Their professionalism and structured workflow made the
                    entire experience seamless.</p>
                <div class="info-item-box">
                    <img src="{{ asset('frontend/assets/img/testimonials-5.jpg') }}" class="rounded-circle" alt="image">
            ...
            <div class="single-testimonials-card" data-aos="fade-up">
                <p>A very smooth and transparent process from start to finish. The dedication and professionalism were
